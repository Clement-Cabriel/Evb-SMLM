...
* Description of the parameters (more details are available directly in the code file):
    ...
    - 'frame_size': size of the sensor array (in pixels) [x,y]. The value should be =[1280,720] for the gen4 sensor.
